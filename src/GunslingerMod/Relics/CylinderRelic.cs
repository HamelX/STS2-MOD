...
{
    private const string CylinderRelicIconPath = "res://images/ui/gunslinger_cylinder.png";

    public override RelicRarity Rarity => RelicRarity.Starter;

    public override string PackedIconPath => CylinderRelicIconPath;

    protected override string PackedIconOutlinePath => CylinderRelicIconPath;

    protected override string BigIconPath => CylinderRelicIconPath;
